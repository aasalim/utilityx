...
configure:
	...
	-DXTemplate_BUILD_TESTS=$(BUILD_TESTS) \
	-DXTemplate_BUILD_EXAMPLES=$(BUILD_EXAMPLES) \
	-DXTemplate_BUILD_COVERAGE=$(BUILD_COVERAGE) \
	-DXTemplate_BUILD_CPPCHECK=$(BUILD_CPPCHECK) \
	-DXTemplate_BUILD_CCACHE=$(BUILD_CCACHE) \
	-DXTemplate_BUILD_DEV=$(BUILD_DEV) 
